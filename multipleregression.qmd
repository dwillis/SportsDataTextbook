...
That presents it's own problems. So let's get set up. The dataset we'll use is all men's college basketball games between 2015 and 2021.
...
dllink <- download_link(
  link = "https://dwillis.github.io/sports-data-files/cbblogs1521.csv",
