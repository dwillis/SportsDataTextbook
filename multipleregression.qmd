...
```{r}
(0.0551813*39.30769	) + (3.8548574*-0.5384615) + (-3.8991399*.669231	) + (3.8612863*6.238462) + 0.5826970
```

By this model, it predicted we would average outscoring our opponents by 22 points over the season! The reality? We were outscored by 8.4 on average.
