...
So let's look at last year's women's basketball team as a group of shooters. Last season we had some strong shooters in Diamond Miller and Abby Meyers, both of whom were drafted by WNBA teams in the first round. Who are the shooters-in-waiting?
...
dllink <- download_link(
  link = "https://dwillis.github.io/sports-data-files/wbb_players_2023.csv",
...
```{r}
players <- read_csv("data/wbb_players_2023.csv")
```
...
The median number of shots is 87, but we only really care about good ones. So let's use 182 attempts -- the third quartile -- as our cutoff.
...
Six Terps took more than 182 shots. Number not on the roster this season? Two, but they were the two most-prolific shooters.
...
So Brinae Alexander was our best shooter by true shooting percentage. Most of the rest were at or above average shooters for that volume of shooting; only Lavender Briggs had a true shooting percentage under 50%.
