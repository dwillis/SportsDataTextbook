...
The first thing to do is [read the documentation](https://cfbfastr.sportsdataverse.org/). You'll see that you can request data for each week. For example, here's week 2, which is actually Maryland's third game (the week 0 game is lumped in with week 1).
