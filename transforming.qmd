...
ggplot(maryland, aes(x=Year, y=Attendance, group=1)) + 
  ...
  labs(x="Year", y="Attendance", title="Ups and Downs, But Mostly Downs", subtitle="A short-lived rebound after the pandemic didn't stick.", caption="Source: NCAA | By Derek Willis", color = "Outcome") +
  theme_minimal() + 
  theme(
