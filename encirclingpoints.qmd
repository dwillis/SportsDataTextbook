...
dllink <- download_link(
  link = "https://raw.githubusercontent.com/dwillis/hhs-snapshots/main/data/player_totals_20230417.csv",
...
```{r}
players <- read_csv("https://raw.githubusercontent.com/dwillis/hhs-snapshots/main/data/player_totals_20230417.csv") %>% filter(mp > 0)
```
