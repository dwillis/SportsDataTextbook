...
First, we need data from the 2021 women's college soccer season.
...
dllink <- download_link(
  link = "https://raw.githubusercontent.com/dwillis/NCAAWomensSoccerData/main/data/ncaa_womens_soccer_matchstats_2022.csv",
...
So on a scale of -1 to 1, where 0 means there's no relationship at all and 1 or -1 means a perfect relationship, penalty yards and whether or not the team scores more points than it give up are at 0.02543571. You could say they're 2.5 percent related toward the positive -- more penalties, the higher your differential. Another way to say it? They're 97.5 percent not related.
...
It means that when you look at every game in college soccer, the number of goals and yellow cards have a negative impact on the score difference between your team and the other team. But the relationship is barely anything at all. Like 93+ percent plus not related. So neither penalties nor yellow cards have much of any relationship with the difference in goal-scoring.
