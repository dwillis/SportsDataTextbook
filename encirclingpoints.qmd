...
dllink <- download_link(
  link = "https://raw.githubusercontent.com/dwillis/hhs-snapshots/main/data/player_totals_20231130.csv",
...
Like we have done in the past, let's make a dataframe of top scorers. We'll set the cutoff at 175 points this early in the season.
...
Now let's clean this up and make it presentable. If you look at the top scorers, just one - Caitlin Clark - is a Division I player. So here's what a chart telling that story might look like.
