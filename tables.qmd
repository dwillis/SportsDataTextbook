...
So what does all of these libraries do? Let's gather a few and use data of every men's basketball game between 2015-2022.
...
dllink <- download_link(
  link = "http://dwillis.github.io/sportsdatafiles/cbblogs1522.csv",
...
```{r}
logs <- read_csv("data/cbblogs1522.csv")
```
...
`Team | 2020-2021 season threes | 2021-2022 season threes | pct change`
...
So there you have it. Toledo changed their team so much they took 25 percent fewer threes in 2021-22 from the season before. Where did Maryland come out? We ranked 21st in college basketball in terms of fewer threes from the season before.
