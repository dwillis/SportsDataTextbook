...
dllink1 <- download_link(
  link = "https://dwillis.github.io/sports-data-files/scoringoffense.csv",
...
dllink2 <- download_link(
  link = "https://dwillis.github.io/sports-data-files/totaloffense.csv",
  button_label = "Download csv file",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
...
Let's look at the offensive numbers from the 2021 Maryland v. Illinois football game. Maryland won 20-17, even though the Terps outgained the Illini by 113 yards. You can find the [official stats on the NCAA's website](https://www.ncaa.com/game/football/fbs/2021/09/17/maryland-illinois/team-stats).
